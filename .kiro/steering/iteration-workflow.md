...
- **日時**: 2024-12-31
- **内容**: スキルボーナスA/B比較検証
- **結果**: ON/OFFで人口+63.6%、アーティファクト+96.6%の差。state→行動接続は機能している。
- **レポート**: `2024-12-31-skill-ab-comparison.md`
...
- H30: スキルボーナスの効果は「余剰」を生み出し、文明発達を加速する（検証中）
...
4. **余剰と文明発達（H30）**: 人口とアーティファクト比率の長期観察
