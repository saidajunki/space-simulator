...
- **日時**: 2024-12-31
- **内容**: H80検証（親子ペアの類似度）
- **結果**: H80を強く支持（親子類似度0.160、同一ノード非親子0.021、比率7.54x）。新仮説H81, H82を追加。
- **レポート**: `2024-12-31-parent-child-similarity.md`
...
2. **H82の検証**: 世代数が離れるほど類似度は低下する
3. **H79の検証**: 方言圏の維持には「移動の制限」が必要
